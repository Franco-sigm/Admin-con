  ...
  return (
    ...
    >
      ...
      <nav className="flex-1 px-3 py-6 space-y-2">
        ...
        <Link to={`/comunidad/${comunidadId}/propiedades`} className={getLinkClasses('propiedades')} title="Propiedades"> 
            <svg className="w-6 h-6 min-w-[24px]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
            <span className={`transition-all duration-200 whitespace-nowrap ${isCollapsed ? 'w-0 overflow-hidden opacity-0' : 'w-auto opacity-100'}`}>
              Propiedades
            </span>
        ...
        <Link to={`/comunidad/${comunidadId}/cargos`} className={getLinkClasses('cargos')} title="Cargos y Gastos Comunes">
           <svg className="w-6 h-6 min-w-[24px]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
           <span className={`transition-all duration-200 whitespace-nowrap ${isCollapsed ? 'w-0 overflow-hidden opacity-0' : 'w-auto opacity-100'}`}>
            Deudas
          </span>
        </Link> 
